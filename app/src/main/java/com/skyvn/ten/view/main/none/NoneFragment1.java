...
import com.skyvn.ten.view.main.home_all_status.HomeAllFragment;
...
public class NoneFragment1 extends SupportFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (findChildFragment(HomeAllFragment.class) == null) {
            loadRootFragment(R.id.fl_first_container, new HomeAllFragment());
        }
    }
